...
- **DgBlog** — TranslationWorkflow.md, writing voice, frontmatter conventions, EN→FR rules
...
2. **Load Translation Rules**: Read `DgBlog`'s `TranslationWorkflow.md` context file for complete EN→FR conventions
...
- **DgBlog Skill Required**: Always loads TranslationWorkflow.md for complete rules
