...
description: "The shared or group intelligence that emerges from the collaboration, collective efforts, and competition of many individuals, enabling groups to solve problems and generate knowledge beyond what any single member could achieve"
aliases:
...
**[[complexity-science|Complexity science]]** provides the core explanatory vocabulary: emergence, self-organization, and adaptive systems. Complex collectives exhibit behaviors that cannot be predicted from the properties of individual members, arising instead from interaction patterns and feedback loops.
...
**[[holomidale-collective-intelligence|Holomidale collective intelligence]]**: Distributed, self-organizing coordination enabled by digital networks. Participants coordinate through mutual transparency, shared norms, and emergent roles without central authority. Characteristic of internet-era commons (Wikipedia, open source, decentralized movements).
...
**[[holoptism|Holoptism]]**: Access to both horizontal (peer activity) and vertical (project aims) information enables participants to self-coordinate without central direction.
...
- **[[open-value-networks|Open Value Networks]]**: Commons-based peer production networks that track contributions transparently and coordinate value creation without hierarchical management.

### Digital collective intelligence
- **[[swarm-computing|Swarm computing]]**: Algorithms inspired by natural collective intelligence (ant colony optimization, particle swarm optimization) applied to distributed computing problems.
...
- **[[cognicism|Cognicism]]**: AI-augmented collective decision-making that tracks belief evolution across communities.
...
[[digital-fabrics|Digital fabrics]] (decentralized coordination infrastructure) provide the substrate for holomidale-style collective intelligence at scale. Where pyramidal intelligence required centralized institutions to function, digital infrastructure enables self-organizing collectives to maintain coherence without hierarchical overhead.

Pierre Lévy (University of Ottawa) describes this transition as the emergence of a "collective intelligence space" enabled by cyberspace: a universal environment where knowledge is continuously produced, shared, and evaluated. His [[information-economy-meta-language|IEML (Information Economy Meta-Language)]] project attempts to provide a semantic layer for structuring collective intelligence across languages and cultures.
...
- [[holomidale-collective-intelligence|Holomidale Collective Intelligence]]: Noubel's framework for internet-era distributed collective intelligence
- [[information-economy-meta-language|IEML (Information Economy Meta-Language)]]: Pierre Lévy's semantic layer for structuring collective intelligence across languages and cultures
- [[holoptism|Holoptism]]: P2P transparency as a necessary condition for collective intelligence
- [[complexity-science|Complexity Science]]: Emergence and self-organization as theoretical foundations
- [[open-value-networks|Open Value Networks]]: Commons-based peer production as collective intelligence in practice
- [[cognicism|Cognicism]]: AI-augmented collective decision-making
- [[digital-fabrics|Digital Fabrics]]: Infrastructure enabling distributed collective coordination
- [[sensorica|Sensorica]]: Open value network demonstrating collective intelligence in scientific production
- [[sociocracy-3|Sociocracy 3.0]]: Consent-based governance as structured collective intelligence
- [[swarm-computing|Swarm Computing]]: Computational implementations of collective intelligence principles
- [[peer-to-peer|Peer-to-Peer Systems]]: Network architecture underlying distributed collective coordination
