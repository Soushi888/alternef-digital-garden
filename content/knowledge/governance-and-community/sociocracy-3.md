...
tags: [governance, organizational-governance, self-management, agile, decision-making, sociocracy-3, consent-based-governance, pattern-library, collaboration, lean-agile]
created: 2025-12-28
modified: 2025-12-28
draft: false
---
...
### Empiricism
S3 encourages organizations to base decisions on evidence, experimentation, and validated learning rather than assumptions or untested theories. This principle draws from [[complexity-science|Complexity Science]] and emphasizes:
...
### Equivalence
Each person in an organization has an equal voice in decisions that affect them, recognizing the unique value and perspective that each individual brings. This principle relates to [[subsidiarity|Subsidiarity]]'s emphasis on local autonomy:
...
### Accountability
Individuals and teams take responsibility for their agreements and commitments, and the organization as a whole takes responsibility for its impact on people and the environment. This principle aligns with [[stewardship|Stewardship]]'s caretaker mindset:
...
- [[knowledge/governance-and-community/index|Governance patterns]]: Circle structure, role definitions, delegation processes
...
### Comparison with [[subsidiarity|Subsidiarity]]
...
### Connection to [[stewardship|Stewardship]]
...
### Relation to [[open-value-networks|Open Value Networks]]
...
### Link to [[complexity-science|Complexity Science]]
...
### Relationship to [[digital-fabrics|Digital Fabrics]]
...
- [[subsidiarity|Subsidiarity]] - Principle of allocating decisions to the most local competent level
...
- [[complexity-science|Complexity Science]] - Frameworks for understanding complex adaptive systems
- [[sensorica|Sensorica]] - Real-world application of self-organizing governance
- [[cosmo-localism|Cosmo-localism]] - Global knowledge sharing with local implementation
- [[digital-fabrics|Digital Fabrics]] - Decentralized coordination infrastructure
