...
date: 2026-07-16
description: "A governance model of multiple autonomous but interdependent decision centers operating at different scales to manage shared resources and complex problems."
aliases:
  - "Polycentricity"
  - "Polycentric governance"
tags: ["governance", "subsidiarity", "commons", "decentralized-systems", "complexity-science"]
draft: false
---
...
- **Subsidiarity**: Problems should be resolved at the most relevant level, as close as possible to the citizens they affect. See [[subsidiarity|Subsidiarity]].
...
The empirical backbone of the model is [[ostroms-design-principles|Ostrom's Design Principles]], eight conditions distilled from cross-cultural study of durable, self-governing institutions. Polycentricity is the structural answer to the [[tragedy-of-the-commons|Tragedy of the Commons]]: shared resources need not collapse under individual self-interest when [[commons|commons]] are governed by nested, accountable rule systems rather than by a single central manager.
...
- [[ostroms-design-principles|Ostrom's Design Principles]] - Empirical conditions for durable polycentric commons governance
- [[subsidiarity|Subsidiarity]] - Handling decisions at the most local competent level
- [[commons|Commons]] and [[tragedy-of-the-commons|Tragedy of the Commons]] - The resource problem polycentricity addresses
- [[complexity-science|Complexity Science]] - Emergent, self-organizing order without central control
