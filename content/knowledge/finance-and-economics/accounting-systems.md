...
While traditional double-entry accounting focuses on financial value, alternative models like [[rea-accounting|REA Accounting]] expand the scope to track resources, events, and agents more comprehensively. REA can be particularly valuable for:
...
Modern [[valueflows|Valueflows]] implementations build on these principles to support decentralized coordination and transparency, while [[local-first-accountability|Local-first Accountability]] approaches apply these concepts to user-controlled, privacy-respecting financial systems.

## Related Topics

- [[rea-accounting|REA Accounting]] - Alternative framework modeling resources, events, and agents
- [[local-first-accountability|Local-first Accountability]] - Software design for user-controlled financial data
- [[valueflows|Valueflows]] - Modern protocol for economic coordination and tracking
