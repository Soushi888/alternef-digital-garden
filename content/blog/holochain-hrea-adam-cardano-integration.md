---
title: Integration of Holochain, hREA/ValueFlows, ADano and Cardano in Open Value Networks
...
date: 2025-04-24
tags: ["blog", "peer-to-peer", "holochain", "cardano", "rea", "valueflows", "adam", "open-value-network", "peer-production"]

---

# Integration of Holochain, hREA/ValueFlows, ADAM and Cardano in Open Value Networks

- **See also**: [PEP Master - Design validation and certification - Trust-based economy](https://example.com/pep-master)
- Part of Funding of PEP Master from web3 platforms initiative.
- Co-authored with [Tiberius Brastaviceanu](https://www.linkedin.com/in/tiberiusbrastaviceanu/) in the context of [Sensorica OVN](https://sensorica.co/).
...
PEP Master is an open-source DIY therapeutic hardware device and computer game (herein called _Instrument_) developed by a consortium involving:
...
> **Credit**: [A new economy documentary film](https://example.com/new-economy-doc)
...
> **Learn More**: [OVN Wiki](https://example.com/ovn-wiki) | [Economic Model](https://example.com/economic-model) | [Peer Production](https://example.com/peer-production)
...
[26] Dearing, J. W. (2009). Applying diffusion of innovation theory to intervention development. Research on Social Work Practice, 19(5), 503-518.
[27] Berwick, D. M. (2003). Disseminating innovations in health care. JAMA, 289(15), 1969-1975.
